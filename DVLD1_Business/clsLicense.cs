...
namespace DVLD1_Business
{
    public class clsLicense
    {
        ...
        public int Detain(float FineFees, int CreatedByUserID, string DetainReason)
        {
        ...
        public clsLicense Replace(enIssueReason IssueReason, int CreatedByUserID)
        {
            ...
            Application.ApplicationStatus = clsApplication.enApplicationStatus.Completed;
            Application.LastStatusDate = DateTime.Now;
            Application.PaidFees = IssueReason == enIssueReason.DamagedReplacement ?
                clsApplicationType.Find((int)clsApplication.enApplicationType.ReplaceDamagedDrivingLicense).Fees
                : clsApplicationType.Find((int)clsApplication.enApplicationType.ReplaceLostDrivingLicense).Fees;
            Application.CreatedByUserID = CreatedByUserID;
        ...
        public static int GetLicenseByDriverID(int DriverID, int LicenseClass)
        {
            return clsLicenseData.GetLicenseByDriverID(DriverID, LicenseClass);
        }
    }
}
