...
namespace DVLD1_Business
{
    public class clsDetainedLicense
    {
        ...
        public string DetainReason { set; get; }
        ...
        public clsDetainedLicense(int DetainID,
            ...
            float FineFees,string DetainReason, int CreatedByUserID,
        ...
        private bool _AddNewDetainedLicense()
        {
            ...
            this.DetainID = clsDetainedLicenseData.AddNewDetainedLicense(
                this.LicenseID, this.DetainDate, this.FineFees,this.DetainReason, this.CreatedByUserID);
        ...
        public static clsDetainedLicense Find(int DetainID)
        {
            ...
            float FineFees = 0;string DetainReson = ""; int CreatedByUserID = -1;
            ...
            ref ReleasedByUserID, ref ReleaseApplicationID))
                ...
                return new clsDetainedLicense(DetainID,
                     ...
                     FineFees,DetainReson, CreatedByUserID,
        ...
        public static clsDetainedLicense FindByLicenseID(int LicenseID)
        {
            ...
            float FineFees = 0;string DetainReason = ""; int CreatedByUserID = -1;
            bool IsReleased = false; DateTime ReleaseDate = DateTime.MaxValue;
            int ReleasedByUserID = -1; int ReleaseApplicationID = -1;

            if (clsDetainedLicenseData.GetDetainedLicenseInfoByLicenseID(LicenseID,
            ref DetainID, ref DetainDate,
            ref FineFees,ref DetainReason, ref CreatedByUserID,
            ref IsReleased, ref ReleaseDate,
            ref ReleasedByUserID, ref ReleaseApplicationID))

                return new clsDetainedLicense(DetainID,
                     LicenseID, DetainDate,
                     FineFees,DetainReason, CreatedByUserID,
                     IsReleased, ReleaseDate,
                     ReleasedByUserID, ReleaseApplicationID);
            else
                return null;
